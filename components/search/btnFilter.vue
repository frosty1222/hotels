...
<template>
  <div ref="stMainMenu" class="relative whitespace-nowrap">
    <button
        class="py-[12px] px-[20px] bg-white border border-solid border-gray-300 rounded-[40px] font-normal text-base leading-[20px] text-[#232323] flex items-center"
    ...
    <div v-show="settings.filterPrice.isShow"
      ...
      <div class="dropdown-title mb-[10px] font-bold text-base leading-[26px] text-[#232323]">
        {{ label }}
      </div>
      <slot name="body"/>
    </div>
